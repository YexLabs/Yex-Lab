          ...
          <div className="flex flex-col items-center mt-96 mx-2">
            <div className="flex flex-col gap-6 items-center">
              ...
              <p className=" w-5/6 text-center z-40">
                Committed to Contract 3.0, to a truly democratic DAO and to
                complete decentralization. See the projects we are contributing
                to below.
              </p>
              {/* white paper */}
              {/* <a href="/whitepaper">
              ...
              >
                ...
                <div className="card">
                  ...
                  <p className="info"> A native DEX on BERA.</p>
                  <div className="share">
                    <a
                      href="https://github.com/honeypotfinance"
                      target="_blank"
                      rel="noreferrer"
                    >
                      <svg
                    ...
                    <a
                      href="https://discord.gg/pkh7shAPWB"
                      target="_blank"
                      rel="noreferrer"
                    >
                      <svg
                  ...
                  <a
                    href="https://honeypot-front-end-ten.vercel.app/"
                    target="_blank"
                    rel="noreferrer"
                  >
                ...
                {/* Splatter */}
                <div className="card" style={{ background: " #5a9ff7" }}>
                  <div className="img">
                    {" "}
                    <img
                      src={splatter_logo}
                  ...
                  <p className="info"> A native DEX on Scroll.</p>
                  <div className="share">
                    <a
                  ...
                  <a
                    href="https://www.splatterprotocol.xyz/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <button>website</button>
