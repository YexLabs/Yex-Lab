            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-xl transform transition-all sm:max-w-md sm:w-3/5">
              ...
              <div className="bg-white px-4 pb-3">
                ...
                <div className="flex gap-1 items-center mt-3">
                  <div
                    className={`flex items-center bg-white ${selectedCoin_input == "ETH"
                  ...
                  <div
                    className={`flex items-center bg-white ${selectedCoin_input == "WETH"
                        ? "bg-slate-100 text-gray-500"
                        : ""
                      }  rounded-lg px-2 py-1 hover:cursor-pointer`}
                    onClick={() => {
                  ...
                  <div
                    className={`flex items-center bg-white ${selectedCoin_input == "USDC"
                        ? "bg-slate-100 text-gray-500"
                        : ""
                      }  rounded-lg px-2 py-1 hover:cursor-pointer`}
                    onClick={() => {
              ...
              <div className="p-3">
                <div
                  className={`${selectedCoin_input == "ETH"
                      ? "opacity-50"
                ...
                <div
                  className={`${selectedCoin_input == "WETH"
                      ? "opacity-50"
                      : "hover:bg-slate-100 hover:cursor-pointer"
                    }    px-4 py-2 rounded-lg mb-2 flex items-center gap-3`}
                ...
                <div
                  className={`${selectedCoin_input == "USDC"
                      ? "opacity-50"
                      : "hover:bg-slate-100 hover:cursor-pointer"
                    }    px-4 py-2 rounded-lg mb-2 flex items-center gap-3`}
